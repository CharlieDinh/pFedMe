...
from fedl.users.userperavg import UserPerAvg
...
class PerAvg(Server):
    def __init__(self, dataset,algorithm, model, batch_size, learning_rate, alpha, lamda, num_glob_iters,
        ...
        for i in range(total_users):
            ...
            user = UserPerAvg(id, train, test, model, batch_size, learning_rate, alpha, lamda, local_epochs, optimizer ,total_users , num_users)
